...
//    $app->get('sites/{airfield_name}/stats', \App\Action\StatsForSiteAction::class)->setName('statsforsite');
    $app->get('/sites/all', \App\Action\AllAirfieldsAction::class)->setName('allairfields');
    $app->get('/sites/{airfield_name}', \App\Action\DailyFlightsAction::class)->setName('airfield');
    $app->get('/sites/{airfield_name}/{date}', \App\Action\DailyFlightsAction::class)->setName('airfielddate');
